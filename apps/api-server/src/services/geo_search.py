...
class GeoSearchService:
    ...
    async def geocode(self, address: str) -> Dict[str, Any]:
        ...
        try:
            rows = await self.session.execute(
                text("SELECT * FROM geocode_address(:query)"),
                {"query": address}
            )
    ...
    async def reverse_geocode(self, lat: float, lng: float) -> Dict[str, Any]:
        ...
        try:
            ...
            street_row = await self.session.execute(text("""
            ...
            return {
                ...
                'address': {
                    ...
                    'house_number': street_result.house_number if street_result else None,
                    'ward': result.ward,
